...
echo "$sql<br />";
			#	    pg_query($sql);										 
			   ...
			   $aviso1 = true;
				 $mensaje_de_aviso1 = "Los datos del predio han sido copiados con éxito!";
			}
   }	 
   ########################################
   #----- LEER DATOS DE INFO-PREDIO ------#
   ########################################	
   ...
   if (($nivel == 1) OR ($nivel == 3)) {
      ...
      echo "                           <input name=\"ver\" type=\"submit\" class=\"smallText\" value=\"Modificar código\">\n";
	    echo "                           <br /><br /> Usa esa opción para re-codificar el lote. Todos los datos adjuntos (Geometría, Edificaciones, Fotos, Impuestos, etc.) recibirón el nuevo código. \n";			
	 }
   echo "                           </td>\n";	 
   echo "                        </tr>\n";	
	 echo "                     </table>\n"; 		  
