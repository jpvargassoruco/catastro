...
########################################	
/*$sql="SELECT cod_pad, tit_1nom1, tit_1nom2, tit_1pat, tit_1mat, 
    dir_tipo, dir_nom, dir_num, dir_edif FROM info_predio WHERE cod_uv = '$cod_uv' AND cod_man = '$cod_man' AND cod_lote = '$cod_lote' AND cod_subl = '$cod_subl'";
$result=pg_query($sql);
...
if ($tit_1nom1 == "") {
   ...
   $titular1 = $tit_1nom1." ".$tit_1nom2." ".$tit_1pat." ".$tit_1mat;
} 	
...
#	 echo "<td>\n";
 ...
 /*  # Fila 1
   ...
   echo "      <tr>\n";  
	 ...
	 echo "                  <td align=\"center\" width=\"39%\" class=\"bodyTextH\">Dirección</td>\n";			
	 echo "               </tr>\n";
 	 echo "               <tr>\n";				 			           
   ...
   # Fila 2
	 if ($nivel > 1) {
	    echo "					<form id=\"form1\" name=\"doublecombo\" method=\"post\" action=\"index.php?mod=5&id=$session_id#tab-5\" accept-charset=\"utf-8\">\n";	 	 
	 }
	 echo "      <tr>\n";  
	 echo "         <td height=\"40\"> &nbsp</td>\n";   #Col. 1                       
	 echo "         <td valign=\"top\" class=\"bodyText\">\n";  #Col. 2	  
...
<!-- Dieses Skript stammt vom JavaScript Einführungskurs  -->
...
<?php 												
	          ...
	          echo "         <td> &nbsp</td>\n";   #Col. 1 				  
 	          echo "         <td align=\"center\">\n"; #Col. 2	
			      echo "            <font color=\"red\"> Está seguro de borrar el cambio seleccionado?</font>\n"; 
			      echo "            <input name=\"id_inmu\" type=\"hidden\" value=\"$id_inmu\">\n"; 		
	          echo "            <input name=\"search_string\" type=\"hidden\" value=\"$search_string\">\n";
