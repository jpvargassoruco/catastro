...
<table border="0" align="center" cellpadding="0" width="800px" height="100%">
	<tr height="40px">
		...
		<?php echo (isset($accion) && $accion == "Modificar") ? "Modificar Contribuyente" : "Registrar Contribuyente"; ?>
		</td>
		<td width="5%"> &nbsp</td> 	 
	</tr>
	<?php	
	// Ensure commonly used form variables are defined to avoid notices
	$__defaults = array('con_pmc'=>'','pmc_ant'=>'','con_raz'=>'','con_nit'=>'','con_pat'=>'','con_mat'=>'','con_nom1'=>'','con_nom2'=>'','dom_dpto'=>'','dom_ciu'=>'','dom_bar'=>'','dom_tipo'=>'','dom_nom'=>'','dom_num'=>'','dom_edif'=>'','dom_bloq'=>'','dom_piso'=>'','dom_apto'=>'','con_fech_nac'=>'','con_tel'=>'','med_agu'=>'','med_luz'=>'','con_obs'=>'','doc_tipo'=>'','doc_num'=>'','doc_exp'=>'','con_tipo'=>'','con_act'=>'0');
		...
		<fieldset><legend>Padron Municipal</legend>
			<table border="0" width="100%">
				...
				<tr>
					...
					<input type="text" name="con_pmc" id="form_anadir1" class="navText" maxlength="$max_strlen_pmc" disabled value="<?php echo $con_pmc ?>"></td>
					<td width="1%"></td>
...
echo "<input type=\"text\" name=\"dir_edif\" id=\"form_anadir1\" class=\"navText\" maxlength=\"$max_strlen_dir_edif\" value=\"$dir_edif_texto\"></td>\n";
...
echo "<table border=\"0\" width=\"100%\">\n";
    ...
    echo "<td align=\"center\" width=\"10%\" class=\"bodyTextD\">\n";
    echo "<input type=\"date\" name=\"con_fecnac\" id=\"form_anadir1\" class=\"navText\" maxlength=\"20\" value=\"$con_fech_nac_input\"></td>\n";
    echo "<td width=\"1%\"></td>\n";
