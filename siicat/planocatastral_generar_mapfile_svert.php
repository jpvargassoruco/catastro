...
$filename = "C:/apache/siicat/mapa/siicat_planocatastral.map";
...
SIZE 1200 1200
EXTENT 350942 7775221 353171 7776799
UNITS  meters
...
END	
 ...
 CLASSITEM 'numero'
    ...
    NAME 'Delimitacion' 
      ...
      COLOR -1 -1 -1
      OUTLINECOLOR 0 0 0 #40 40 40			
	    SIZE 3 # el grosor del predio seleccionado 
	  END
	END # end_of_class
END # end of layer object
#----------------------------------------------------------- Predio-Seleccionado
 ...
 CLASSITEM 'numero'
    ...
    NAME 'Delimitacion' 
		...
		STYLE
		  SYMBOL 'gestrichelt3'
      COLOR -1 -1 -1
      OUTLINECOLOR 255 255 255 #40 40 40			
	    SIZE 0
	  END
	END # end_of_class
END # end of layer object
