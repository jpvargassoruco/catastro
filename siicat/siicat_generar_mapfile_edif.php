...
$filename = "C:/apache/siicat/mapa/siicat_edif.map";
...
#EXTENT 184846 7647725 189046 7650725
...
WEB
 LOG cat_br.log
 TEMPLATE catbr_predios.html
 IMAGEPATH 'c:/apache/htdocs/tmp/'
 IMAGEURL 'http://$server/tmp/'
 EMPTY 'http://$server/$folder/nada.html'
 
 METADATA
  WMS_ONLINERESOURCE 'http://$server/cgi-bin/mapserv.exe?map=c:/apache/siicat/mapa/siicat_edif.map'
  WMS_SRS 'epsg:32720'
  WMS_ACCESSCONSTRAINTS 'none'
  WMS_TITLE 'SIICAT_EDIF'
...
END	
 ...
 CLASSITEM 'number'
	CLASS 
    NAME 'Delimitación' 
		EXPRESSION (('[number]' == '55') AND ('[user_id]' == '$user_id'))             
		STYLE
		  SYMBOL 'circle'
      COLOR -1 -1 -1
      OUTLINECOLOR 255 0 0 #40 40 40			
	    SIZE 2
	  END
	END # end_of_class
END # end of layer object
...
END	
 ...
 CLASSITEM 'number'
	CLASS 
    NAME 'Delimitación' 
		EXPRESSION (('[number]' == '44') AND ('[user_id]' == '$user_id'))             
		STYLE
		  SYMBOL 'circle'
      COLOR -1 -1 -1
