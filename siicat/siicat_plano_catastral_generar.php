...
$content = " 
<div align='left'>
<table border='1' width='100%' height='100' style='border:2px solid black; border-collapse:collapse; font-family: Tahoma; font-size: 8pt' bgcolor='#FFFFFF'><font face='Tahoma' size='2'>
   <tr>
      <td rowspan='2' colspan='3'>
			    <table>
					   <tr>
						    <td width='20%'>
                   	 <img src='http://$server/$folder/css/$nomlog' alt='imagen' width='95' height='101' border='0'>
										        
                </td>
								<td width='80%' align='center'>

								   <font style='font-family: Tahoma; font-size: 9pt;'>GOBIERNO AUTONOMO MUNICIPAL DE</font><br />
									 <font style='font-family: Tahoma; font-size: 9pt;'>$municipio</font><br />								 
   ...
   <tr height='20'>
      ...
      <td align='left' colspan='3'>
         <font style='font-family: Tahoma; font-size: 9pt;'>&nbsp SUP. SEGUN MENS. : $area m2</font>
      </td>
      <td align='left' colspan='3'>
         <font style='font-family: Tahoma; font-size: 9pt;'>&nbsp SUP. SEGUN DOC. : $adq_sdoc m2</font>
      </td>													 				
   </tr>
   <tr height='20'>			
   ...
   <tr>
      <td align='center' height='550px' colspan='7' bgcolor='#FFFFFF'>	 
         <iframe frameborder='0' name='mapserver' src='http://$server/cgi-bin/mapserv.exe?map=c:/apache/siicat/mapa/siicat_planocatastral.map&program=http://$server/cgi-bin/mapserv.exe&zoomsize=2&layer=Predios&layer=Manzanos&layer=Puntos&layer=Calles&imgext=$xmin $ymin $xmax $ymax&imgxy=700+550&mapext=&savequery=false&zoomdir=1&mode=map&imgbox=&imgsize=1400+1100&mapsize=1400+1100' id='content' width='700px' height='550px' align='middle' valign='center' scrolling='no' noresize='no' marginwidth='0' marginheight='0'>
				 </iframe>
			</td>
   </tr>	
   <tr>
	    <td align='center' colspan='7'>
               ...
               <td valign='top' colspan='2'>
			            <table border='1' width='100%' height='100%' style='border-collapse:collapse; font-family: Tahoma; font-size: 8pt' bgcolor='#FFFFFF'>
				             <tr height='10%'>
                        <td width='10%' align='center'>ID
                        </td>
                        <td width='20%' align='center'>ESTE 
                         </td>							 
                        <td width='20%' align='center'>NORTE 
                        </td>
                        <td width='10%' align='center'>ID 
                        </td>
                        <td width='20%' align='center'>ESTE 
...
$content = $content . "
   $coordenadas_y2	
               ...
               <td align='center' valign='top' width='30%' rowspan='3'>
                  <font style='font-family: Tahoma; font-size: 9pt;'>APROBACION CATASTRO.</font> 
               </td>
               <td align='left' valign='top' width='30%' rowspan='3'>
                  <font style='font-family: Tahoma; font-size: 9pt;'>&nbsp&nbsp&nbsp H.A.M. $municipio</font><br /><br /><br />
               ...
               <td align='left'>
                  <font style='font-family: Tahoma; font-size: 7pt;'> &nbsp OBSERVACIONES:<br /> 
									 ...
									 &nbsp dirección técnica de catastro.</font>
               </td>
