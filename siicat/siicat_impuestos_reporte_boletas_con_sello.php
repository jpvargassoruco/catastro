...
$sql="SELECT DISTINCT no_orden, fech_imp, hora, usuario, id_inmu, gestion, cuota, control, forma_pago FROM imp_pagados WHERE fech_imp >= '$fecha_inicio' AND fech_imp <= '$fecha_final' AND (forma_pago = 'CONTADO' OR forma_pago = 'VALIDADO') $and_user AND cuota > '0' ORDER BY fech_imp, hora";
#echo $sql;
	 ...
	 <tr height='700px'>
      ...
      <td align='center' valign='top' width='80%' bgcolor='#FFFFFF'>
               ...
               <td align='left' valign='middle' colspan='8'>				 
                  <br /><br />SIICAT - SISTEMA INTEGRAL DE CATASTRO
							 </td>
               <td align='right' valign='middle'>				 
                  <br /><br />Fecha: $fecha2
				    ...
				    <tr height='30'>
						   <td align='left'>&nbsp </td>
               <td align='left' valign='middle' colspan='8'>				 
                   GOBIERNO MUNICIPAL: $dom_ciu_MAYUS, DISTRITO $dom_ciu_MAYUS
							 </td>
               <td align='right' valign='middle'>				 
                  Hora: $hora
							 </td>								 
               ...
               <td align='center' valign='middle' colspan='9' style='font-family: Tahoma; font-size: 10pt; font-weight:bold;'>				 
                   REPORTE: BOLETAS DE PAGO CON SELLO
							 </td>
							 <td align='left'>&nbsp </td>
						</tr>	
				    <tr height='30'>
