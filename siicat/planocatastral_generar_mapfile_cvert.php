...
$filename = "C:/apache/siicat/mapa/planocatastral.map";
...
WEB
 LOG siicat.log
 TEMPLATE siicat_planocatastral.html
 IMAGEPATH 'c:/apache/htdocs/tmp/'
 IMAGEURL 'http://$server/tmp/'
 EMPTY 'http://$server/$folder/nada.html'
 
 METADATA
  WMS_ONLINERESOURCE 'http://$server/cgi-bin/mapserv.exe?map=c:/apache/siicat/mapa/siicat_planopredial.map'
  WMS_SRS 'epsg:32720'
  WMS_ACCESSCONSTRAINTS 'none'
  WMS_TITLE 'SIICAT_PREDIO'
 ...
 CLASSITEM 'activo'
    ...
    EXPRESSION '1'              
      ...
      OUTLINECOLOR 80 80 80	
	    SIZE 1 # el grosor de los predios colindantes
	  END
	END # end_of_class
...
END	
 ...
 CLASSITEM 'numero'
    ...
    NAME 'Delimitacion' 
      ...
      OUTLINECOLOR 0 0 0 #40 40 40
      WIDTH 3
	    SIZE 4 # el grosor del predio seleccionado 
	  END
	END # end_of_class
END # end of layer object
#----------------------------------------------------------- Predio-Seleccionado
...
END # end of layer object
#----------------------------------------------------------- Edificaciones-Seleccionadas
#----------------------------------------------------------- Edificaciones-Seleccionadas-Anotacion
LAYER
  CONNECTIONTYPE postgis
  NAME 'edificiones'
	GROUP 'Predios'
...
END
	...
	LABELITEM 'edi_num'
      ...
      END
END  # END OF LAYERFILE
#----------------------------------------------------------- Edificaciones-Seleccionadas-Anotaci�n
#----------------------------------------------------------- Radio_Ochaves
LAYER
  CONNECTIONTYPE postgis 
  NAME 'Radio_Ochaves'
...
LAYER
  ...
  CLASS
    ...
    LABEL
      ...
      OUTLINEWIDTH 1
      FONT 'arial'        # este alias debe existir en tu fonts.fnt
      TYPE TRUETYPE
      SIZE 16
      POSITION AUTO
      PARTIALS FALSE
  ...
  GRID
    MININTERVAL $mininterval     # distancia mínima entre líneas (en metros, porque usas EPSG:32720)
    MAXINTERVAL $maxinterval
    LABELFORMAT '%.0f'     # formato de etiqueta numérica
  END
END
