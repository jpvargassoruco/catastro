...
$sup_terr= number_format($value['area'],2,'.','');
pg_free_result($result);
...
########################################
$sql="SELECT AsText(the_geom),npoints(the_geom) FROM predios_ocha WHERE cod_geo = '$cod_geo' AND cod_uv = '$cod_uv' AND cod_man = '$cod_man' AND cod_pred = '$cod_pred'";
$result = pg_query($sql);
$info = pg_fetch_array($result, null, PGSQL_ASSOC);
...
while ($i <= $no_de_vertices-1) {
   if ($i == $no_de_vertices-1) {
	 ...
	 $c = get_linelen ($point_x[$j], $point_y[$j], $point_x[$i], $point_y[$i]);
	 if ($c > $min_value) {
	    $c = $c." m";        
...
include "planocatastral_generar_mapfile_svert.php";
$total_avaluo = $avaluo_terr + $savaluo;
$filename = "C:/apache/htdocs/tmp/pc2".$cod_cat.".html";
################################################################################
#----------------------------  GENERAR CODIGO QR   ----------------------------#
################################################################################	
...
#------------------------       CONTROL DE No C.C.       ----------------------#
################################################################################
$sql="SELECT * FROM docu_control WHERE id_doc = 4";
$result=pg_query($sql);
$info = pg_fetch_array($result, null, PGSQL_ASSOC);
...
<table width='100%' height='1000px' style='border: 1px solid black;'>
    <tr>
        <td>
            <table valign='top' width='100%' height='40px'  style='border: 1px solid black;'>
                <tr>
                    <td width='80px'>
                    ...
                    <td width='250px' height='100px'>
                        <table width='100%' height='80px'>
                            ...
                            <tr style='height:10'>
                                <td align='center' style='font-family: Arial; font-size: 5pt;'>$titulo1</td>
                            </tr>
                            <tr style='height:10'>
                        ...
                        <table width='100%' height='100px' style='border: 1px solid black;'>
                            <tr>
                                ...
                                <td align='right'  colspan='3'>
                                    <font style='font-family: Arial; font-size: 13pt;'>&nbsp&nbsp No.$nro_doc/$gestion_actual</font>
                                </td>                                
                            </tr>
                            <tr>
                                <td colspan='4' align='center' style='font-family: Arial; font-size: 20pt; font-weight:bold;' align='center'>CERTIFICADO CATASTRAL</td>
                            </tr>
                            <tr style='border: 1px solid black; border-collapse: collapse;'>
                                <td align='center' colspan='1' width='40%' style='border: 1px solid black; border-collapse: collapse;'>
                                    <font style='font-family: Arial; font-size: 6pt;'>CODIGO CATASTRAL DEL $municipio_abr </font>
                                </td>
            ...
            <table width='100%'   style='border: 1px solid black; font-family: Arial; font-size: 9pt;'>
                <tr>
                    <td align='left'  colspan='10'>
                        <p style='font-family: Arial; font-size: 10pt;'>$titulo5</p>
                    </td>
                </tr>	
                ...
                <tr style='font-family: Arial; font-size: 9pt;'>
                    <td colspan='1' width='10%'>&nbsp</td>
                    <td colspan='1' align='center' width='30%' style='border: 1px solid black; border-color:#9b9b9b'>$testimonio</td>
                    <td colspan='1' width='20%'>&nbsp</td>
            ...
            <table width='100%' style='border: 1px solid black; font-family: Arial; font-size: 8pt;'>
                ...
                <tr>
                    ...
                    <td align='center' colspan='1' width='10%' style='border: 1px solid black; border-color:#9b9b9b'>&nbsp $cod_pr_ddrr </td>	
                    <td align='right'  colspan='1' width='13%' style='font-weight:bold;'>Manzana No.:</td>
                    <td align='center' colspan='1' width='10%' style='border: 1px solid black; border-color:#9b9b9b'>$cod_ant_man</td>	
                    <td align='right'  colspan='1' width='10%' style='font-weight:bold;'>Distrito:</td>
                    <td align='center' colspan='1' width='10%' style='border: 1px solid black; border-color:#9b9b9b'> &nbsp </td>                													
                </tr>	
                <tr>
                ...
                <tr>
                    ...
                    <td align='right' colspan='1' width='12%' style='font-weight:bold; '>Ubicacion:</td>	
                    <td align='left'  colspan='5' width='53%' style='font-family: Arial; font-size: $font_size_dir; border: 1px solid black; border-color:#9b9b9b'>&nbsp $direccion </td>				
                </tr>
                <tr><td style='font-family: Arial; font-size: 4pt; '>&nbsp</td></tr>
            </table>	
                ...
                <tr>
                    <td width='50%'>
                        <table width='100%' style='border: 1px solid black;'>
                            <tr >
                                <td colspan='4' width='50%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'> 2. DATOS DE IDENTIDAD DEL PROPIETARIO (S)</td>
                            </tr>                                            
                        </table>   

                        <table width='100%' height='133px' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                            <tr style='font-family: Arial; font-size: 8pt;'>
                                <td align='left'   colspan='3' width='70%'><font >&nbsp $prop1</font></td>                  
                                <td align='center' colspan='1' width='20%'>$tit_1ci</td>	
                                <td align='right'  colspan='1' width='10%' style='font-weight:bold;'> &nbsp</font></td>
                            </tr>	
                            <tr>
                                <td align='left'   colspan='3' width='70%'>&nbsp $prop2</td>                   
                                <td align='center' colspan='1' width='20%'>$tit_2ci</td>	
                                <td align='right'  colspan='1' width='10%' style='font-weight:bold;'>&nbsp</td>						
                            </tr>	
                            <tr>
                                <td align='left'   colspan='3' width='70%'>&nbsp $prop3</td>                   
                                <td align='center' colspan='1' width='20%'>$tit_3ci</td>	
                                <td align='right'  colspan='1' width='10%' style='font-weight:bold;'>&nbsp</td>						
                            </tr>	
                            <tr>
                                <td align='left'   colspan='3' width='70%'>&nbsp $prop4</td>                   
                                <td align='center' colspan='1' width='20%'>$tit_4ci</td>	
                                <td align='right'  colspan='1' width='10%' style='font-weight:bold;'>&nbsp</td>						
                            </tr>
                            <tr>
                                <td align='left'   colspan='3' width='70%'>&nbsp $prop5</td>
                                <td align='center' colspan='1' width='20%'>$tit_5ci</td>	
                                <td align='right'  colspan='1' width='10%' style='font-weight:bold;'>&nbsp</td>						
                            </tr>                                
                            <tr><td style='font-family: Arial; font-size: 4pt; '>&nbsp</td></tr>
                        </table>
                    ...
                    <td width='50%'>
                        <table width='100%' style='border: 1px solid black;'>
                            <tr >
                                <td colspan='4' width='50%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>4. DATOS DEL TERRENO</td>
                            </tr>                                            
                        </table>   
                        <table border='1' width='100%'  height='133px' style='border: 1px solid black; border-collapse: collapse;'>
                            <tr>
                                <td colspan='2' width='55%' style='font-family: Arial; font-size: 8pt; font-weight:bold;'>
                                    <table border='0' width='100%' style='font-family: Arial; font-size: 8pt;'>
                                        <tr>
                                            <td colspan='2' width='50%'>4.1 SUPERFICIE:</td>
                                        </tr>
                                        <tr>    
                                        ...
                                        <tr>
                                            <td colspan='1' width='25%'>Ubicacion:</td>
                                            <td colspan='1' width='25%' align='center' style='border: 1px solid black; border-color:#9b9b9b'>$ter_ubi</td>                      
                                        </tr>                                                                                                                                               
                                    </table>
                                </td>
                                <td colspan='2' width='45%'>
                                    <table border='0' width='100%' style='font-family: Arial; font-size: 8pt;'>
                                        <tr>
                                            <td colspan='2' width='50%'>4.2 DIMENSIONES:</td>
                                        </tr>
                                        <tr>    
                                        ...
                                        <tr>
                                            ...
                                            <td colspan='1' width='25%' align='center' style='border: 1px solid black; font-family: Arial; font-size: $font_size_dim; border-color:#9b9b9b'>$ter_fren</td>                            
                                        </tr> 
                                        <tr>
                                            <td colspan='1' width='25%'>Contra frente:</td>
                                            <td colspan='1' width='25%' align='center' style='border: 1px solid black;  font-family: Arial; font-size: $font_size_dim; border-color:#9b9b9b'>$ter_con_fre</td>                            
                                        </tr>     
                                        <tr>
                                            <td colspan='1' width='25%'>Fondo:</td>
                                            <td colspan='1' width='25%' align='center' style='border: 1px solid black;  font-family: Arial; font-size: $font_size_dim; border-color:#9b9b9b'>$ter_fond</td>                            
                                        </tr>  
                                        <tr>
                                            <td colspan='1' width='25%'>Contra fondo:</td>
                                            <td colspan='1' width='25%' align='center' style='border: 1px solid black;  font-family: Arial; font-size: $font_size_dim; border-color:#9b9b9b'>$ter_con_fon</td>                            
                                        </tr>    
                                        <tr>
                                            <td colspan='1' width='25%'>&nbsp</td>
                                            <td colspan='1' width='25%'>&nbsp</td>                            
                ...
                <tr>
                    <td width='50%' >
                        <table border='0' width='100%''>
                            ...
                            <tr>
                                <td align='center' height='350px' colspan='4' rowspan='16' bgcolor='#FFFFFF' style='vertical-align:top;'>	 
                                    <iframe frameborder='0' 
                                            ...
                                            marginwidth='0' 
                                            marginheight='0'>
                                    </iframe><font style='font-family: Arial; font-size: 8pt;' >$NomSisCoo</font>
                                </td>	
                            </tr>                      
                        </table>              
                    </td>
                    <td width='50%'> 
                        <table width='100%' style='border: 1px solid black;'>
                            <tr >
                                <td colspan='4' width='50%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>4.3.COLINDANCIAS</td>
                            </tr>                                            
                        </table>   
                        <table width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                            <tr>
                                <td colspan='1' width='20%'>$limite1:</td>
                                <td colspan='1' width='80%'>$Colind1</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='20%'>$limite2:</td>
                                <td colspan='1' width='80%'>$Colind2</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='20%'>$limite3:</td>
                                <td colspan='1' width='80%'>$Colind3</td>
                            </tr>                                                                                                                   
                            <tr>
                                <td colspan='1' width='20%'>$limite4:</td>
                                <td colspan='1' width='80%'>$Colind4</td>
                            </tr>
                        </table>  
                        ...
                        <table width='100%' border='1' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse; '>
                            <tr >
                                <td colspan='1' width='30%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>4.4. P.H. NOMBRE</td>
                                <td colspan='3' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp</td>
                            </tr>                          
                            <tr>
                                <td colspan='1' width='30%'>BLOQUE:</td>
                                <td colspan='1' width='20%'>&nbsp</td>
                                <td colspan='2' width='50%' align='center'>COLINDANCIAS:</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='30%'>DEPARTAMENTO</td>
                                <td colspan='1' width='20%'>&nbsp</td>
                                <td colspan='1' width='25%'>SUPERIOR</td>
                                <td colspan='1' width='25%'>&nbsp</td>                                
                            </tr>
                            <tr>
                                <td colspan='1' width='25%'>No.PISO:</td>
                                <td colspan='1'>&nbsp</td>
                                <td colspan='1'>INFERIOR</td>
                                <td colspan='1'>&nbsp</td>   
                            </tr>                                                                                                                   
                        </table>  
                        ...
                        <table width='100%' style='border: 1px solid black;'>
                            <tr >
                                <td colspan='4' width='50%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>4.5. SERVICIOS BASICOS</td>
                            </tr>                                            
                        </table>  
                       <table width='80%' border='0' >
                            <tr>
                                <td align='left'  colspan='1'>
                                    <font style='font-family: Arial; font-size: 8pt;'>&nbsp&nbsp&nbsp AGUA:</font>
                                </td>	
                                <td align='left'  colspan='1' style='border: 1px solid black; vertical-align:top; border-color:#9b9b9b'>
                                    <font style='font-family: Arial; font-size: 8pt;'> &nbsp $ser_agu</font>
                                </td>										
                            </tr>		
                            <tr>
                                <td align='left'  colspan='1'>
                                    <font style='font-family: Arial; font-size: 8pt;'>&nbsp&nbsp&nbsp ELECTRICIDAD:</font>
                                </td>
                                <td align='left'  colspan='1' style='border: 1px solid black; vertical-align:top; border-color:#9b9b9b'>
                            ...
                            <tr style='border: 1px solid black; vertical-align:top;'>
                                <td align='left'  colspan='1'>
                                    <font style='font-family: Arial; font-size: 8pt;'>&nbsp&nbsp&nbsp ALCANTARILLADO:</font>
                                </td>
                                <td align='left'  colspan='1' style='border: 1px solid black; vertical-align:top; border-color:#9b9b9b'>
                            ...
                            <tr style='border: 1px solid black; vertical-align:top;'>
                                <td align='left'  colspan='1'>
                                    <font style='font-family: Arial; font-size: 8pt;'>&nbsp&nbsp&nbsp GAS:</font>
                                </td>
                                <td align='left'  colspan='1' style='border: 1px solid black; vertical-align:top; border-color:#9b9b9b'>
                                    <font style='font-family: Arial; font-size: 8pt;'> &nbsp $ser_gas  </font>
                                </td>												
                            </tr>
                        </table>
                        ...
                        <table width='100%' border='1' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse; '>
                            <tr >
                                <td colspan='2' width='40%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>5. DATOS ECONOMICOS</td>
                            </tr>                          
                            <tr>
                                <td colspan='1' width='30%'>USO Y DESTINO:</td>
                                <td colspan='1' width='20%'>&nbsp $ter_uso_tex</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='30%'>ZONA HOMOGENEA</td>
                                <td colspan='1' width='20%'>&nbsp $ben_zona</td>                              
                            </tr>                                                                                                                
                        </table>  
                        <table width='100%' style='border: 1px solid black;'>
                            <tr >
                                <td colspan='4' width='100%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>6. VALOR CATASTRAL DEL INMUEBLE</td>
                            </tr>                                            
                        </table>  

                       <table width='100%' style='font-family: Arial; font-size: 8pt;'> 
                            <tr>
                                <td colspan='1' width='50%'>&nbsp Gestion:</td>   
                                <td colspan='1' width='50%'>$ges_ult</td>                        
                            </tr>
                            <tr>
                                <td colspan='1' width='50%'>&nbsp Valor del terreno (bs)</td>   
                                <td colspan='1' width='50%'>$avaluo_terreno</td>                        
                            </tr> 
                            <tr>
                                <td colspan='1' width='50%'>&nbsp Valor edificacion</td>
                                <td colspan='1' width='50%'>$avaluo_const</td>                          
                            </tr> 
                            <tr>
                                <td colspan='1' width='50%'>&nbsp Valor catastral</td>
                                <td colspan='1' width='50%'> $avaluo_total</td>                          
                            </tr>                                                                                                                                 
                       </table>    
                    </td>
                </tr>   
            ...
            <table width='100%' border='1' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse;'>
                <tr>
                    <td colspan='4' width='28%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp

                    </td>
                    <td colspan='7' width='70%'>
                        <table width='100%' border='1' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse; '>
                            <tr>
                                <td colspan='8' width='100%' style='font-family: Arial; font-size: 9pt; font-weight:bold;'>7. DATOS DE LA CONSTRUCCION</td>
                            </tr>            
                            <tr>
                                <td colspan='1' width='20%' align='center'>&nbsp</td>
                                <td colspan='1' width='12%' align='center'>P.1.</td>
                                <td colspan='1' width='12%' align='center'>P.2.</td>
                                <td colspan='1' width='10%' align='center'>P.3.</td>
                                <td colspan='1' width='10%' align='center'>P.4.</td>
                                <td colspan='1' width='10%' align='center'>P.5.</td>
                                <td colspan='1' width='10%' align='center'>P.6.</td>
                                <td colspan='1' width='12%' align='center' style='font-weight:bold;'>Total Sup.</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='20%' align='left'>&nbsp Superficie m2</td>
                                <td colspan='1' width='12%' align='center'>$area_edif[0]</td>
                                <td colspan='1' width='12%' align='center'>$area_edif[1]</td>
                                <td colspan='1' width='10%' align='center'>$area_edif[2]</td>
                                <td colspan='1' width='10%' align='center'>$area_edif[3]</td>
                                <td colspan='1' width='10%' align='center'>$area_edif[4]</td>
                                <td colspan='1' width='10%' align='center'>$area_edif[5]</td>
                                <td colspan='1' width='12%' align='center' style='font-weight:bold;'>$edi_area</td>
                            </tr>  
                            <tr>
                                <td colspan='1' width='20%' align='left'>&nbsp Tipologia</td>
                                <td colspan='1' width='12%' align='center'>$edi_tipo[0]</td>
                                <td colspan='1' width='12%' align='center'>$edi_tipo[1]</td>
                                <td colspan='1' width='10%' align='center'>$edi_tipo[2]</td>
                                <td colspan='1' width='10%' align='center'>$edi_tipo[3]</td>
                                <td colspan='1' width='10%' align='center'>$edi_tipo[4]</td>
                                <td colspan='1' width='10%' align='center'>$edi_tipo[4]</td>
                                <td colspan='1' width='12%' align='center'>&nbsp</td>
                            </tr>  
                            <tr>
                                <td colspan='1' width='20%' align='left'>&nbsp Estado</td>
                                <td colspan='1' width='12%' align='center'>$edi_edo[0]</td>
                                <td colspan='1' width='12%' align='center'>$edi_edo[1]</td>
                                <td colspan='1' width='10%' align='center'>$edi_edo[2]</td>
                                <td colspan='1' width='10%' align='center'>$edi_edo[3]</td>
                                <td colspan='1' width='10%' align='center'>$edi_edo[4]</td>
                                <td colspan='1' width='10%' align='center'>$edi_edo[5]</td>
                                <td colspan='1' width='12%' align='center'>&nbsp</td>
                            </tr>
                            <tr>
                                <td colspan='1' width='20%' align='left'>&nbsp Antiquedad</td>
                                <td colspan='1' width='12%' align='center'>$edi_ano[0]</td>
                                <td colspan='1' width='12%' align='center'>$edi_ano[1]</td>
                                <td colspan='1' width='10%' align='center'>$edi_ano[2]</td>
                                <td colspan='1' width='10%' align='center'>$edi_ano[3]</td>
                                <td colspan='1' width='10%' align='center'>$edi_ano[4]</td>
                                <td colspan='1' width='10%' align='center'>$edi_ano[5]</td>
                                <td colspan='1' width='12%' align='center'>&nbsp</td>
                            </tr>                                                                
                        </table>    
                        <table width='100%' border='0' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse;'>
                            <tr height='90' style='font-family: Arial; font-size: 10pt;'>

                                <td colspan='3' align='center' valign='bottom' width='40%'>	&nbsp </td>	
	                                <td colspan='1' align='center' valign='bottom' rowspan='5' width='15%'>
                            ...
                            <tr style='font-family: Arial; font-size: 10pt;'>
                                <td colspan='2' align='center' valign='bottom' width='50%'>&nbsp</td>	
                                <td colspan='2' align='center' valign='bottom' width='50%'>&nbsp</td>																
                            </tr>
                            <tr style='font-family: Arial; font-size: 8pt;'>
                                <td colspan='2' align='center' width='50%'> APROBACION </td>
                                <td colspan='2' align='left' width='50%'>&nbsp&nbsp&nbsp&nbsp&nbsp RESPONSABLE </td>																	
                            </tr>				

                            <tr>
                                <td colspan='4' align='center' width='100%' style='font-family: Arial; font-size: 8pt;'>
                                    EL PRESENTE CERTIFICADO SERA DE ENTERA Y TOTAL RESPONSABILIDAD DEL INTERESADO       
                                </td>												
                            </tr>                
                        </table>
                    </td>                    
            ...
            <table width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black; border-collapse: collapse; '>
                <tr>
                    <td colspan='1' width='65%'><b>Observaciones:</b> &nbsp $ctr_obs</td>
                    <td colspan='1' width='35%' align='right'><b>Fecha:</b> &nbsp $fecha_actual </td>
                </tr>   
                <tr>
                    <td colspan='1' width='65%' align='left' style='font-family: Arial; font-size: 7pt;'><b>Dir:</b> &nbsp $dir_mun </td>
                    <td colspan='1' width='35%' align='right' style='font-family: Arial; font-size: 7pt;'<b>E-mail:</b> $dir_cor</td>
                </tr>   
