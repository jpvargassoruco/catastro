...
$filename = "C:/apache/siicat/mapa/siicat_vertices.map";
...
SIZE 1200 1200
#EXTENT 700000 8225000 730000 8255000
EXTENT 351348 7775587 352940 7776563
UNITS  meters
...
#
WEB
 LOG siicat_vertices.log
 TEMPLATE siicat_vertices.html
 IMAGEPATH 'c:/apache/htdocs/tmp/'
 IMAGEURL 'http://$server/tmp/'
 EMPTY 'http://$server/$folder/nada.html'
 
 METADATA
  WMS_ONLINERESOURCE 'http://$server/cgi-bin/mapserv.exe?map=c:/apache/siicat/mapa/siicat_vertices.map'
  WMS_SRS 'epsg:32720'
  WMS_ACCESSCONSTRAINTS 'none'
  WMS_TITLE 'SIICAT_VERTICES'
...
METADATA
 WMS_SRS 'epsg:32720'
 WMS_TITLE 'colindante'
 WMS_GROUP_TITLE 'Predio'
 WMS_FEATURE_INFO_MIME_TYPE 'text/html'
END
...
END	
 ...
 CLASSITEM 'numero'
	CLASS 
    NAME 'Predio'
		EXPRESSION (( '[numero]' == '5' ) AND ('[user_id]' == '$user_id' ))               
		STYLE
		  SYMBOL 'linea'
      COLOR 200 200 200
	    SIZE 2
...
END	
 ...
 CLASSITEM 'numero'	
	CLASS 
    NAME 'Predio'
		EXPRESSION (( '[numero]' == '2' ) AND ('[user_id]' == '$user_id' ))               
		STYLE
		  SYMBOL 'circle'
      COLOR -1 -1 -1
			OUTLINECOLOR 255 0 0		
	...
	CLASS 
    NAME 'Predio'
		EXPRESSION (( '[numero]' == '10' ) AND ('[user_id]' == '$user_id' ))               
  	STYLE
	 	  SYMBOL 'circle'
       COLOR -1 -1 -1
...
END
  ...
  LABELITEM 'label'
    ...
    END  # CLASS
    CLASS
     NAME 'Codigo Colindantes'
     EXPRESSION (( '[numero]' == '5' ) AND ('[user_id]' == '$user_id' ) AND ('[cod_cat]' != '$cod_cat' ))
      LABEL
       TYPE TRUETYPE
       FONT tahoma
       SIZE 10
...
CLASSITEM 'id'
    ...
    CLASS
     NAME 'Calle'
      EXPRESSION (( '[id]' == '0' ) AND ('[user_id]' == '$user_id' ))
		 STYLE
		   SYMBOL 'gestrichelt2'
       COLOR 0 0 255
	     SIZE 1
 ...
 END
   ...
   TRANSPARENCY 1000
    ...
    END  # END_OF_CLASS	
		CLASS
      NAME 'TEXT'
      EXPRESSION ((( '[pos]' == 'NO' )OR('[pos]' == 'NE' )OR( '[pos]' == 'SO' )OR('[pos]' == 'SE' )OR('[pos]' == '--' )) AND ('[user_id]' == '$user_id' )) 
      STYLE
         SYMBOL 'vertice'
				SIZE 3
      END
