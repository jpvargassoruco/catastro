...
$filename = "C:/apache/siicat/mapa/siicat_planocatastral_ubicacion.map";
...
#
NAME 'SIICAT_PLANOPREDIAL_UBICACION'
STATUS ON
...
WEB
 LOG siicat.log
 TEMPLATE siicat_planocatastral_ubicacion.html
 IMAGEPATH 'c:/apache/htdocs/tmp/'
 IMAGEURL 'http://$server/tmp/'
 EMPTY 'http://$server/$server/nada.html'
 
 METADATA
  WMS_ONLINERESOURCE 'http://$server/cgi-bin/mapserv.exe?map=c:/apache/siicat/mapa/siicat_planocatastral_ubicacion.map'
  WMS_SRS 'epsg:32720'
  WMS_ACCESSCONSTRAINTS 'none'
  WMS_TITLE 'SIICAT_PLANOCATASTRAL_UBICACION'
      ...
      CLASS
       NAME 'U.V.'
			 ...
			 STYLE
			    SYMBOL 'circle'
          COLOR -1 -1 -1
          OUTLINECOLOR 2 167 250 #40 40 40
			    SIZE 3
			 END
      END  # CLASS
