...
$filename = "C:/apache/catastro/mapa/igm_rural.map";
...
WEB
 ...
 METADATA
  WMS_ONLINERESOURCE 'http://$server/cgi-bin/mapserv.exe?map=c:/apache/catastro/mapa/igm_rural.map'
  WMS_SRS 'epsg:32720'
...
LAYER
  ...
  TYPE RASTER
  STATUS ON	
  DATA 'c:/apache/catastro/data/p230r071_20100720_b345_cut.tif'
...
LAYER
  NAME 'muni'
	...
	STATUS ON
  DATA 'C:/apache/catastro/data/ccp_limite'
  TYPE LINE
METADATA
 WMS_SRS 'epsg:32720'
 WMS_TITLE 'muni'
...
LAYER
  NAME 'depart'
	GROUP 'Division_Politica'
	STATUS ON
  DATA 'C:/apache/catastro/data/limite_dep'
  TYPE LINE
METADATA
 WMS_SRS 'epsg:32720'
 WMS_TITLE 'depart'
...
LAYER
  NAME 'predios'
	GROUP 'Predios'
	STATUS ON
  DATA 'C:/apache/catastro/data/san_inra'
  TYPE POLYGON
	TEMPLATE 'igm_query_predios_rural.htm'	
METADATA
 WMS_SRS 'epsg:32720'
 WMS_TITLE 'predios'
...
LAYER
  NAME 'caminos'
	GROUP 'Red de vias'
	STATUS ON
  DATA 'C:/apache/catastro/data/caminos_ult'
  TYPE LINE
METADATA
 WMS_SRS 'epsg:32720'
