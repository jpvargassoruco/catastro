...
$centroid_x = number_format($cstr['x'],3,',','');
$centroid_y = number_format($cstr['y'],3,',','');
...
$titulo1 = utf8_decode($info['titulo1']);
...
<table border='0' width='100%' height='100' style='border-bottom:1px solid black; border-collapse:collapse; font-family: Tahoma; font-size: 8pt'>
	<tr>
...
<table  width='100%' height='50' >
	...
	<tr>
		<td align='center'  colspan='10'>
			<font style='font-family: Arial; font-size: 14pt;'>$municipio_abr &nbsp&nbsp No.$nro_doc/$gestion_actual</font>
		</td>
	</tr>
	<tr>
		<td align='left'  colspan='10'>
			<p style='font-family: Arial; font-size: 10pt;'>$titulo1</p>
		</td>
	</tr>		
</table>	
...
<table  width='100%'>
	...
	<tr>
		<td align='center'  colspan='1' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 11pt; font-weight:bold;'>$cod_geo</font>
		</td>
		<td align='center'  colspan='1' style='border: 1px solid black;  border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 11pt; font-weight:bold; color:#0000ff'>$cod_cat</font>
		</td>
		<td align='center'  colspan='1' style='border: 1px solid black;  border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 11pt; font-weight:bold;'>$matricula</font>
		</td>				
	</tr>		
</table>	
...
<table border='0' width='100%' style='border: 1px solid black;'>
	...
	<tr>
		...
		<td colspan='1' width='28%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $depart</font>
		</td>
		<td colspan='1' width='12%' align='right'>
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>Dist. Catastral</font>
		</td>
		<td colspan='1' width='18%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $cod_uv_c</font>
		</td>	
		...
		<td colspan='1' width='15%' align='center'>
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>No Asiento</font>
		</td>
		<td colspan='1' width='1%'>
			<font style='font-family: Arial; font-size: 8pt;' >&nbsp</font>
		</td>															
		...
		<td colspan='1' width='28%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $provincia_may</font>
		</td>
		<td colspan='1' width='12%' align='right' >
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>No Manzana</font>
		</td>	
		<td colspan='1' width='18%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $cod_man_c</font>
		</td>
		<td colspan='1' width='10%'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp</font>
		</td>	
		...
		<td colspan='1' width='15%' align='center' style='border: 1px solid black; border-color:#9b9b9b'>
	...
	<tr>
		...
		<td colspan='1' width='28%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $municipio</font>
		</td>
		<td colspan='1' width='12%' align='right' >
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>Predio</font>
		</td>	
		<td colspan='1' width='18%' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $cod_pred_c</font>
		</td>
		<td colspan='1' width='10%'>&nbsp</td>	
		<td colspan='1' width='1%'>&nbsp</td>
        <td colspan='1' width='15%' align='center' >
	...
	<tr>
		...
		<td colspan='1' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $cod_dis</font>
		</td>
		<td colspan='1' align='right'  >
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>Barrio/Urb.</font>
		</td>	
		<td colspan='2' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 7pt;'>&nbsp $barrio</font>
		</td>	
		<td colspan='1'>&nbsp</td>	
		<td colspan='1' style='border: 1px solid black; border-color:#9b9b9b'>&nbsp</td>	
		<td colspan='1'>&nbsp</td>						
	</tr>	
	<tr>
		<td  colspan='1' align='right'>
		...
		<td colspan='1' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $distrito</font>
		</td>
		<td colspan='1' align='right'>
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>Dirección</font>
		</td>	
		<td colspan='5' style='border: 1px solid black; border-color:#9b9b9b'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $direccion</font>
		</td>
...
<table width='100%' style='border: 1px solid black;'>
	...
	<tr>
		...
		<td  colspan='3' width='45%'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $prop1</font>
		</td>
		<td align='right'  colspan='1' width='15%'>
	...
	<tr>
		...
		<td colspan='3' width='45%'>
			<font style='font-family: Arial; font-size: 8pt;'>&nbsp $prop2</font>
		</td>
		<td align='right'  colspan='1' width='15%'>
			<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>Carnet de Identidad</font>
		</td>
...
<table width='100%'>
	<tr>
		<td width='25%' style='border: 1px solid black; vertical-align:top;'>
			<table width='100%'>
				...
				<tr>
					...
					<td align='left'  colspan='1' >
						<font style='font-family: Arial; font-size: 7pt;'>&nbsp $ter_topo</font>
					</td>						
				</tr>
				<tr>
					<td align='left'  colspan='1'>
				...
				<tr>
					...
					<td align='center'  colspan='1' >
						<font style='font-family: Arial; font-size: 7pt;'> A > B </font>
					</td>						
				</tr>
				<tr>
					<td align='left'  colspan='1'>
				...
				<tr>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>&nbsp&nbsp Minimo:</font>
					</td>	
				...
				<tr>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>&nbsp&nbsp Agua</font>
					</td>
					<td align='left'  colspan='1' style='vertical-align:top;'>
				...
				<tr style='border: 1px solid black; vertical-align:top;'>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>&nbsp&nbsp Electricidad:</font>
					</td>
					<td align='left'  colspan='1' style='vertical-align:top;'>
				...
				<tr style='border: 1px solid black; vertical-align:top;'>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>&nbsp&nbsp Alcantarillado:</font>
					</td>
					<td align='left'  colspan='1' style='vertical-align:top;'>
				...
				<tr style='border: 1px solid black; vertical-align:top;'>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 8pt; font-weight:bold;'>&nbsp&nbsp Telefono:</font>
					</td>
					<td align='left'  colspan='1' style='vertical-align:top;'>
						<font style='font-family: Arial; font-size: 8pt;'> &nbsp $ser_tel  </font>
					</td>												
				</tr>																													
			</table>	
		</td>
		...
		<td width='40%' colspan='4' rowspan='2' style='border: 1px solid black;'>
			<table width='100%'> 
				<tr >
				...
				<tr>
					<td align='left' height='350px' width='100%' colspan='4' bgcolor='#FFFFFF' style='vertical-align:top;'>	 
				...
				<tr style='font-family: Arial; font-size: 8pt;'>
					<td colspan='1' width='25%' style='font-weight:bold;'>ESTE(X):</td>
					<td colspan='1' width='25%'>$centroid_x</td>
					<td align='right' colspan='1' width='25%' style='font-weight:bold;'>NORTE(Y)</td>
					<td align='right' colspan='1' width='25%'>$centroid_y</td>
				</tr>
			</table>	
		</td>	
	</tr>
			...
			<table width='100%'>
				...
				<tr>
					<td align='left' colspan='1' bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp &nbsp 6.1 Total Superficie Construida: (m²) </font>
					</td>
					<td align='left' colspan='1' bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt;'>$edi_area</font>
					</td>																
				</tr>
				<tr>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp &nbsp 6.2 Tipologia de Construccion: </font>
					</td>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt;'>$edi_tipo[0]</font>
					</td>															
				</tr>
				<tr>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp &nbsp 6.3 Estado de la Construcción: </font>
					</td>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt;'>$edi_edo[0]</font>
					</td>															
				</tr>	
				<tr>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp &nbsp 6.4 Uso de Construcción: </font>
					</td>			
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt;'>$ter_uso_tex</font>
					</td>													
				</tr>	
				<tr>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>&nbsp &nbsp 6.5 Antiguedad Construcción: </font>
					</td>
					<td align='left' colspan='1'  bgcolor='#FFFFFF'>	 
						<font style='font-family: Arial; font-size: 9pt;'> $edi_ano[0]</font>
					</td>															
				</tr>																					
			</table>	
		</td>	
...
<table width='100%'>
	<tr>
		<td width='49%' style='border: 1px solid black;'>
			<table width='100%'>
				...
				<tr>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>Solicitante:</font>
					</td>	
					<td align='left'  colspan='2'>
				...
				<tr>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>No de Tramite Adm:</font>
					</td>								
				</tr>
				<tr>
					<td align='left'  colspan='1'>
						<font style='font-family: Arial; font-size: 9pt; font-weight:bold;'>Motivo: </font>
					</td>					
					<td align='left'  colspan='2'>
						<font style='font-family: Arial; font-size: 8pt;'> REGISTRO CATASTRAL</font>
					</td>									
				</tr>					
			</table>
		</td>
		<td width='51%' rowspan='2'  valign='top' style='border: 1px solid black;'>
			<table border='0' width='100%' style='font-family: Arial; font-size: 8pt; border-bottom: 1px solid black;'>
				<tr>
					<td align='left' colspan='4' style='font-weight:bold;'>7. ESTADO IMPOSITIVO</font></td>								
				</tr>
				<tr style='border: 1px solid black;'>
					<td colspan='1' width='30%' align='left' style='font-weight:bold;'>Gestion:</td>
					<td colspan='1' width='20%' align='center'>$gestion</td>							
					<td colspan='2' width='50%' align='left' style='font-weight:bold; '>Valor:</td>	
				</tr>
			</table>
			<table border='0' width='100%' style='font-family: Arial; font-size: 8pt; '>
				<tr>
					<td align='left'  colspan='1' width='50%' style='font-weight:bold;'>Valor del terreno (Bs.):</td>
					<td align='right' colspan='1' width='12%' >$avaluo_terreno</td>
					<td align='right' colspan='1' width='20%'>&nbsp</td>
					<td align='right' colspan='1'>&nbsp</td>
				</tr>
				<tr>
					<td align='left' colspan='1' style='font-weight:bold;'>Valor de la construción (Bs.):</td>	
					<td align='right' colspan='1'>$avaluo_const</td>			
					<td align='right' colspan='1'>&nbsp</td>	
					<td align='right' colspan='1'>&nbsp</td>								
				</tr>
				<tr>
					<td align='left' colspan='1' style='font-weight:bold;'>Valor Catastral (Bs.):/td>	
					<td align='right' colspan='1'>$avaluo_total</td>									
					<td align='right' colspan='1'>&nbsp</td>		
					<td align='right' colspan='1'>&nbsp</td>			
				</tr>								
			</table>
	...
	<tr>
		<td width='49%' style='border: 1px solid black;'>
			<font style='font-family: Arial; font-size: 9pt;'><b>Observaciones:</b> $ctr_obs</font>
		</td>
	</tr>
...
<table border='0' width='100%' style='border: 1px solid black;'>
	<tr>
			...
			<table border='0' width='100%'>
				<tr>
					<td align='left' width='80%' colspan='4'>
						<p style='font-family: Arial; font-size: 7pt;'>8. Actualmente dicho lote de terreno se encuentra ubicado 
						en la ciudad de $ciudad Perteneciente al distrito $cod_dis $distrito_min, Municipio de $municipio_min, Compresion de la Provincia $provincia 
						del deportamento de $depart,  $ley_creacion</p>
					</td>				
				</tr>
				...
				<tr height='55' style='font-family: Arial; font-size: 8pt;'>
				...
				<tr height='5' style='font-family: Arial; font-size: 8pt;'>
					<td align='center' valign='bottom'>	&nbsp </td>	
					<td align='center' valign='bottom'>_________________________</td>	
					<td align='center' valign='bottom'>_____________________________________</td>																	
				</tr>
				<tr height='10'  style='font-family: Arial; font-size: 8pt;'>
					<td align='center' valign='bottom'>$fecha2</td>	
					<td align='center' valign='bottom'>	&nbsp </td>
					<td align='center' valign='bottom'>TECNICO RESPONSABLE</td>	
					<td align='center' valign='bottom'>DIRECTOR DE DESARROLLO URBANO</td>																	
				</tr>				
		...
		<td align='center' width='20%'>
			<img src='http://$server/$folder/graphics/timbre.png' alt='imagen' width='120' height='150' border='0'>
		</td>		
