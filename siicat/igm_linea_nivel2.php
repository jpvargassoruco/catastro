<?php
 ...
 echo "<table border=\"0\" align=\"center\" cellpadding=\"0\" width=\"770px\">\n";   # 3 Columnas
    echo "<tr height=\"40px\">\n";
        ...
        echo "<tr>\n";
        echo "<td valign=\"top\">\n"; 
            include "informe_linea_nivel_generar2.php";
            echo "<iframe frameborder=\"0\" name=\"mapserver\" src=\"http://$server/tmp/ln2_$cod_cat.html\" id=\"content\" width=\"750px\" height=\"1270px\" align=\"left\" scrolling=\"no\"  noresize=\"no\" marginwidth=\"0\" marginheight=\"0\">\n";
            echo "</iframe>\n";	
        echo "</td>\n";	 
    echo "</tr>\n";	 		
 echo "</table>\n";
