		...
		<fieldset><legend>Padron Municipal</legend>
			<table border="0" width="100%">
				...
				<tr>
					...
					<input type="text" name="con_pmc" id="form_anadir1" class="navText" maxlength="$max_strlen_pmc" readonly value="<?php echo $con_pmc ?>"></td>
					<td width="1%"></td>
					<td align="center" width="24%" class="bodyTextH">Padron Antiguo:</td>
					<td align="center" width="24%" class="bodyTextD">
					<input type="text" name="pmc_ant" id="form_anadir1" class="navText" maxlength="$max_strlen_pmc" readonly  value="<?php echo $pmc_ant ?>"></td>
					<td width="1%"></td>
				</tr>
				<tr>
					<td align="center" colspan="9" class="bodyText">
					El Patron Municipal el sistema asignará un número correlativo!
					</td>
				</tr>
			</table>
		</fieldset>
