...
if (isset($_POST['factor'])) {
	...
	if ($check_zoom > 0) {
		...
		$factor = 1; #(definido en siicat_config)
	}
}
########################################
#------------- FORMULARIO -------------#
...
echo "<table border=\"0\" align=\"center\" cellpadding=\"0\" width=\"770px\">\n";   # 3 Columnas
	echo "<tr height=\"40px\">\n";
		...
		echo "<form id=\"form1\" name=\"form1\" method=\"post\" action=\"index.php?mod=302&inmu=$id_inmu&id=$session_id\">\n";
		...
		include "plano_ubicacion_generar.php";
		echo "<iframe frameborder=\"0\" name=\"mapserver\" src=\"http://$server/tmp/pc$cod_cat.html\" id=\"content\" width=\"770px\" height=\"1160px\" align=\"left\" scrolling=\"no\"  noresize=\"no\" marginwidth=\"0\" marginheight=\"0\">\n";
		echo "</iframe>\n";
		echo "</td>\n";
	echo "</tr>\n";
echo "</table>\n";
