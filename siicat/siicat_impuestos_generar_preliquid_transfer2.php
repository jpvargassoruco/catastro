...
$espacio_arriba_en_la_pagina = false;
$espacio_en_medio_en_la_pagina = false;
$ancho_primera_fila_preliquidacion = 1;
$ancho_fila_en_medio_preliquidacion = 1;
$ancho_entre_contrib_banco = 30;   #30
$ancho_entre_banco_alcaldia = 39;  #35
$ancho_barra_cabecera = "22pt";
$ancho_entre_original_y_copia = "2pt"; #12pt

if  ($calcular_transfer_rural) {
   $cod_cat = $codcat_transfer	= get_codcat_from_id_predio_rural($id_predio_rural);
	 $tipo_inmu_texto = "PROPIEDAD RURAL";
}
...
if ($espacio_arriba_en_la_pagina) {
$content = $content." 
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 4pt'>
   <tr>	 
      <td rowspan='7' align='left' width='15%' bgcolor='#E9E9E9' style='font-family: $fontfam; font-size: 7pt'>
			   <table border='0' width='100%' style='border-collapse:collapse; font-family: $fontfam; font-size: 7pt'>
				 <tr>
				 <td>
				 <br />
         &nbsp SISTEMA2: $sistema<br />				 
         &nbsp FORM: 1980<br />
				 &nbsp $casilla_trans_objeto<br />
				 &nbsp IMPUESTO A LA<br />
				 &nbsp TRANSFERENCIA<br />
				 &nbsp FOLIO:<br />
				 &nbsp $folio<br />
				 &nbsp $casilla_trans_numero<br />
				 &nbsp PAGO TOTAL<br />
				 &nbsp GESTION: $ano_actual<br />	
				 <br />
				 </td>
				 </tr>
				 </table>		 
      </td>	
      <td colspan='5' bgcolor='#E9E9E9' style='font-family: $fontfam; font-size: $ancho_barra_cabecera'>
         &nbsp
      </td>					
   </tr>	 
   <tr> 
      <td align='left' width='14%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp FECHA EMISION:
      </td>
      <td align='left' width='28%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         $fecha2 $hora
      </td>			
      <td align='left' width='23%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         CAJERO: $user_id
      </td>	
      <td align='left' width='15%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         FOLIO: $folio
      </td>
      <td rowspan='2' width='20%' align='right' valign='top' style='font-family: $fontfam; font-size: 7pt'>";
if ($imprimir_preliq) {
$content = $content." 
...
$content = $content."
   ...
   <tr> 
      <td colspan='2' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp <b>IDENTIFICACION DEL CONTRIBUYENTE</b><br />&nbsp NOMBRE: $titular<br />&nbsp DOCUMENTACION: $ci_nit<br />&nbsp DOMICILIO LEGAL: $dom_ciu, $dom_dir
      </td>	
      <td colspan='2' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp<br />P.M.C.: $cod_pad<br />TIPO CONTRIBUYENTE: $tit_tipo<br />NRO. CUENTA LUZ: 
      </td>											
   </tr>
   <!-- Fila 3: DATOS DEL INMUEBLE -->	 
   <tr> 
      <td colspan='2' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp <b>DATOS DEL INMUEBLE</b><br />&nbsp TIPO INMUEBLE: $tipo_inmu_texto<br />&nbsp DIRECCION: $direccion
      </td>	
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 1pt'>	 
   ...
   <tr>  
      ...
      <td width='58%' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp NOMBRE: $comprador<br />&nbsp DOCUMENTACION: $comp_ci_texto<br />&nbsp DOMICILIO LEGAL: $dom_dir_comp
      </td>	
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 1pt'>	 
   ...
   <tr> 
      ...
      <td align='left' width='22%' style='font-family: $fontfam; font-size: 7pt'>
         TOTAL A PAGAR: <b>$total_a_pagar Bs.</b>
      </td>	
      <td align='left' width='49%' style='font-family: $fontfam; font-size: 7pt'>
         SON: <b>$monto_en_letras 00/100 Bs.</b>
      </td>	
      <td align='left' width='25%' style='font-family: $fontfam; font-size: 7pt'>
...
if ($nota_fecha_venc_preliquid) {
   $espacio_en_filas++;
   $content = $content."<br />*) Debe solicitar otra pre-liquidaci�n cuando se pasa la fecha de vencimiento indicada!";
}
if ($nota_condonacion) {
   $espacio_en_filas++;
...
<!--                          COPIA SEGUNDA BOLETA                           -->
<!--                     XXXXXXXXXXXXXXXXXXXXXXXXXXXXX                       -->
<table border='0' width='100%' style='font-family: $fontfam; font-size: 6pt'>
   <tr>
      <td style='font-family: $fontfam; font-size: $ancho_entre_original_y_copia'>
         &nbsp
      </td>		 
   </tr>
</table>
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 4pt'>
   ...
   <tr> 
      ...
      <td rowspan='2' align='right' width='20%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
			   &nbsp
      </td>																		
   </tr>		 
   <tr> 
   ...
   <tr> 
      ...
      <td colspan='2' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp <br /> CODIGO CATASTRAL: <br />$codcat_transfer
      </td>											
   </tr> 		 	 		  
</table>
<!-- Fila 4: IDENTIFICACION DEL COMPRADOR O CESIONARIO --> 
