...
if ((isset($_POST["id_inmu"])) OR (isset($_GET["inmu"]))) {
   ...
   if (isset($_POST["id_predio_rural"])) {
	    ...
	    $id_item = $id_predio_rural = $_GET["idpr"];
	 }
...
#echo "SQL: $sql, $id_inmu, $check_tabla";
...
#echo "L166 $sql<br />";
   ...
   $sql = "SELECT folio, min_fech, modo_trans, fech_imp_venc, total_a_pagar FROM imp_transfer_rural WHERE id_predio_rural = '$id_predio_rural' AND estatus = 'PRELIQUID' ORDER BY folio";
}
      ...
      foreach ($line as $col_value) {
			   if ($i == 0) {
				    $folio_array[$j] = $col_value;
				       ...
				       $concepto_tabla[$j] = "TRANSFER RURAL";
						}
				 } elseif ($i == 1) {
				    $min_fech_tabla[$j] = $col_value;
#echo "L186 $col_value,$min_fech_tabla[0]<br />";
				 } elseif ($i == 2) {
...
#   echo "            <img border='1' src='http://$server/$folder/graphics/boton_atras.png' width='35' height='35'></a>\n"; 
   ...
   echo "         <td align=\"center\" valign=\"center\" width=\"90%\" class=\"pageName\">\n";
	 if ($calcular_transfer_urbano) {
      ...
      echo "            Transferencia de Propiedad Rural\n";
   }                       
   echo "         </td>\n";
   ...
   echo "      <tr>\n";  
	 ...
	 if ($calcular_transfer_urbano) {	 	
      ...
      echo "               </tr>\n";	
 	    ...
 	    echo "               <tr>\n";		
	    echo "                  <td align=\"center\" width=\"18%\" class=\"bodyTextH\">Código</td>\n";
	    echo "                  <td width=\"1%\"> &nbsp</td>\n";	
	    echo "                  <td align=\"center\" width=\"28%\" class=\"bodyTextH\">Nombre del Predio</td>\n";		
	    echo "                  <td width=\"1%\"> &nbsp</td>\n";						 
	    echo "                  <td align=\"center\" width=\"39%\" class=\"bodyTextH\">Titular Principal</td>\n";
	    echo "                  <td width=\"1%\"> &nbsp</td>\n";		 
	    echo "                  <td align=\"center\" width=\"12%\" class=\"bodyTextH\">P.M.C.</td>\n";
	    echo "               </tr>\n";
 	    echo "               <tr>\n";				 			           
	    echo "                  <td align=\"center\" class=\"bodyTextD\">$cod_cat</td>\n";
	    echo "                  <td> &nbsp</td>\n";		 	 
	    echo "                  <td align=\"center\" class=\"bodyTextD\">$nom_pred_texto</td>\n";				
	    echo "                  <td> &nbsp</td>\n";	 	  
	    echo "                  <td align=\"center\" class=\"bodyTextD\">$titular1_ant</td>\n";
	    echo "                  <td> &nbsp</td>\n";	 
	    echo "                  <td align=\"center\" class=\"bodyTextD\">$cod_pad_ant</td>\n";	 		 
...
#	 echo "                  <td align=\"center\" width=\"60%\" class=\"bodyTextD\"><input type=\"text\" name=\"der_num_ant\" id=\"form_anadir1\" class=\"navText\" maxlength=\"50\" value=\"$adq_doc_ant\" $disabled></td>\n";   #Col. 3	
   ...
   echo "                        </tr>\n";
	# if (!$registro_banco_existe) {
      ### MOSTRAR PRE-LIQUIDACIONES IMPRESAS ###	    	 	
      $i = 0;
...
#   echo "         <input name=\"tit_xid_ant\" type=\"hidden\" value=\"$tit_xid_ant\">\n"; 
