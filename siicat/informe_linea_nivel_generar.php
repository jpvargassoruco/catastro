...
#---------------------------- SELECCIONAR GRAFICO -----------------------------#
################################################################################	
$filename = "C:/apache/htdocs/$folder/graphics/uso/".$area_uso."_seccion.jpg";
...
<table border='1' width='100%' height='161' style='border:2px solid black; border-collapse:collapse; font-family: Tahoma; font-size: 8pt' bgcolor='#FFFFFF'><font face='Tahoma' size='2'>
   <tr>
      ...
      <td rowspan='2' colspan='4'>
         <table border='0' width='100%' style='font-family: Tahoma; font-size: 10pt' bgcolor='#FFFFFF'><font face='Tahoma' size='2'>
            <tr>
               <td colspan='1'>
                  <font style='font-family: Tahoma; font-size: 8pt; font-weight:bold; color:red'>No. </font>
               </td>
               <td colspan='3' align='right'>		 
                  $fecha2 - $hora <a href='javascript:print(this.document)'>
                  <img border='0' src='http://$server/$folder/graphics/printer.png' width='15' height='15' title='Imprimir en tamano CARTA'></a>
               </td>               
            </tr>  
            <tr>
               <td align='center' valign='center' colspan='4'> &nbsp </td>            
            </tr>            
            <tr>
   ...
   <tr height='30px' style='font-family: Tahoma; font-size: 8pt'>
      ...
      <td rowspan='8' align='left' valign='bottom' colspan='5'>
         &nbsp ESQUEMA DE ALTURAS 
				 <img src='http://$server/$folder/uso/$grafico.jpg' alt='imagen'  height='316' border='0'>
      </td>								 				
   </tr>	
	 <tr height='30px' style='font-family: Tahoma; font-size: 8pt;'>					
