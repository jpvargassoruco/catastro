...
$titular2 = get_contrib_nombre($tit_2id_ant);
$ci_nit2 = get_contrib_ci($tit_2id_ant);
################################################################################
#------------------------- RUTA Y NOMBRE PARA GRABAR --------------------------#
################################################################################	
$filename = "C:/apache/htdocs/tmp/boleta_trans_".$cod_cat.".html";
$gestion_vencida = $ano_actual - 2;
################################################################################
#------------------------------- PREPARAR DATOS -------------------------------#
################################################################################	
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 4pt'>
   ...
   <tr> 
      ...
      <td align='right' width='20%' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp
      </td>                                                    
   </tr>     
   <tr> 
   ...
   <tr> 
      <td colspan='2' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp NOMBRE 1: $titular $ci_nit <br />&nbsp NOMBRE 2: $titular2 $ci_nit2<br />&nbsp DOMICILIO LEGAL: $dom_ciu, $dom_dir
      </td> 
   ...
   <tr> 
      ...
      <td colspan='1' align='left' valign='top' style='font-family: $fontfam; font-size: 8pt'>
         CODIGO CATASTRAL3: <br />$codcat_transfer
      </td>					
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 1pt'>  
   ...
   <tr>  
      ...
      <td width='58%' align='left' valign='top' style='font-family: $fontfam; font-size: 7pt'>
         &nbsp NOMBRE 1: $comprador $comp_ci_texto<br />&nbsp NOMBRE 2: $comprador2 $comp_ci_texto2  <br />&nbsp DOMICILIO LEGAL: $dom_dir_comp
      </td> 
...
<table border='0' width='100%' style='font-family: $fontfam; font-size: 1pt'>  
   ...
   <tr> 
      ...
      if ($nota_fecha_venc_preliquid) {
         $espacio_en_filas++;
         $content = $content."*) Debe solicitar otra pre-liquidaciOn cuando se pasa la fecha de vencimiento indicada!";
      }
      if ($nota_condonacion) {
         $espacio_en_filas++;
      ...
      if (($area_predio_manual) OR ($area_predio_manual)) {
         $espacio_en_filas++;
         $content = $content."<br />x) Por falta de la geometria se aplica la superficie s/ documentos, caso de ser distinta de la superficie mensurada se rectificar� el monto de la gesti�n.";
      }
