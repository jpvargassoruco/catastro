...
$filename = "C:/apache/htdocs/tmp/ln2_" . $cod_cat . ".html";
################################################################################
#----------------------------  GENERAR CODIGO QR   ----------------------------#
################################################################################	
...
#------------------------       CONTROL DE No C.C.       ----------------------#
################################################################################
$sql = "SELECT * FROM docu_control WHERE id_doc = 5";
$result = pg_query($sql);
$info = pg_fetch_array($result, null, PGSQL_ASSOC);
...
################################################################################	
$sql = "SELECT * FROM edif_normas";
$result = pg_query($sql);
$info_norma = pg_fetch_array($result, null, PGSQL_ASSOC);
$tip_edi = $info_norma['tip_edi'];
$ret_fro = $info_norma['ret_fro'];
$ret_lat = $info_norma['ret_lat'];
$ret_pos = $info_norma['ret_pos'];
$voladizos = $info_norma['voladizos'];
$alt_de_lin = $info_norma['alt_de_lin'];
$alt_de_ver = $info_norma['alt_de_ver'];
$otro_usos = $info_norma['otro_usos'];
$vis_dir = $info_norma['vis_dir'];
$vis_obl = $info_norma['vis_obl'];
$cai_agu = $info_norma['cai_agu'];
$nota_linea = $info_norma['nota_linea'];
$obs_linea = $info_norma['obs_linea'];
pg_free_result($result);
################################################################################
...
<table border='1' width='100%' height='100' style='border: 2px solid black; border-collapse:collapse;'>
   <tr>
      <td>
         <table width='100%'>
            <tr>
               <td width='80px'><img src='http://$server/$folder/css/$nomlog' alt='imagen' width='90' height='90' border='0'></td>
               ...
               <td width='400px'>
                  <table width='100%' height='100px' style='border: 1px solid black;'>
                     ...
                     <tr>
                        <td colspan='4' align='center' style='font-family: Arial; font-size: 20pt; font-weight:bold;' align='right'>LINEA NIVEL</td>
                     </tr>
         ...
         <table width='100%' style='border: 1px solid black; font-family: Arial; font-size: 8pt;'>
            <tr>
               <td align='left'  colspan='8' style='font-family: Arial; font-size: 10pt; font-weight:bold;'>1. DATOS DE UBICACION DEL INMUEBLE</td>			
            </tr>
            <tr>
         ...
         <table width='100%'>
            <tr>
               <td  width='60%' >
                  <table width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr style='font-family: Arial; font-size: 10pt; font-weight:bold;'>
                        <td align='left' colspan='6' width='100%'> 2. DATOS DE IDENTIDAD DEL PROPIETARIO</td>			
                     </tr>
                     <tr style='font-family: Arial; font-size: 8pt;'>
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>
                        <td align='left'   colspan='3' width='60%'>&nbsp $prop1</font></td>                  
                        <td align='center' colspan='1' width='15%'>$tit_1ci</td>	
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>                            
                     </tr>	
                     <tr>
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>
                        <td align='left'   colspan='3' width='60%'>&nbsp $prop2</font></td>                  
                        <td align='center' colspan='1' width='15%'>$tit_2ci</td>	
                        <td align='right'  colspan='1' width='3%'> &nbsp</td> 	
                     </tr>	
                     <tr>
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>
                        <td align='left'   colspan='3' width='60%'>&nbsp $prop3</font></td>                  
                        <td align='center' colspan='1' width='15%'>$tit_3ci</td>	
                        <td align='right'  colspan='1' width='3%'> &nbsp</td> 					
                     </tr>	
                     <tr>
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>
                        <td align='left'   colspan='3' width='60%'>&nbsp $prop4</font></td>                  
                        <td align='center' colspan='1' width='15%'>$tit_4ci</td>	
                        <td align='right'  colspan='1' width='3%'> &nbsp</td> 		
                     </tr>
                     <tr>
                        <td align='right'  colspan='1' width='3%'> &nbsp</td>
                        <td align='left'   colspan='3' width='60%'>&nbsp $prop5</font></td>                  
                        <td align='center' colspan='1' width='15%'>$tit_5ci</td>	
                        <td align='right'  colspan='1' width='3%'> &nbsp</td> 				
                     </tr>                                
                  </table>	   
               </td>
               <td  width='40%' > 
                  <table width='100%'style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr style='font-family: Arial; font-size: 10pt; font-weight:bold;'>
                        <td align='left' colspan='4' width='100%'> 3. LINEAMIENTOS TECNICOS</td>			
                     </tr>   
                     <tr><td style='font-family: Arial; font-size: 8pt; '>&nbsp</td></tr>	
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td align='right'  colspan='1' width='3%' > &nbsp</font></td>
                        <td align='left'   colspan='2' width='50%'>Uso de suelo1.</td>
                        <td align='center' colspan='2' width='15%'>&nbsp $tipo_inmu</td>	
                        <td align='right'  colspan='1' width='10%'>&nbsp</td>						
                     </tr>      
                     <tr><td style='font-family: Arial; font-size: 8pt; '>&nbsp</td></tr>	  
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td align='right'  colspan='1' width='3%'  &nbsp</font></td>
                        <td align='left'   colspan='2' width='50%'>Uso actual.</td>
                        <td align='center' colspan='2' width='15%'>&nbsp</td>	
                        <td align='right'  colspan='1' width='10%'>&nbsp</td>						
                     </tr>                                                           
                     <tr><td style='font-family: Arial; font-size: 6pt; '>&nbsp</td></tr>	
                  </table>	 
               </td>
            </tr>
         </table>	
         ...
         <table width='100%'>
            <tr>
               <td  width='60%' colspan='1'>
                  <table width='100%' height='280px' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr style='font-family: Arial; font-size: 10pt; font-weight:bold;'>
                        <td align='left' width='100%'> 4. LA LINEA Y/O RASANTE MUNICIPAL</td>			
                     </tr>
                     <tr style='font-family: Arial; font-size: 9pt; font-weight:bold;'>
                        <td align='center' width='100%'><img src='http://$server/$folder/graphics/uso/4_linea nivel.jpg' alt='imagen' width='95%' border='0'></td>
                     </tr>
               ...
               <td  width='40%' colspan='1' >
                  <table width='100%' height='280px' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr valign='top' style='font-family: Arial; font-size: 10pt; font-weight:bold;'>
                        <td align='left'  width='100%'> 5. UBICACION DEL PREDIO</td>			
                     </tr>
                     <tr>
            ...
            <tr>
               <td  width='100%' colspan='2'  align='left' style='font-family: Arial; font-size: 8pt;'>
                  Nota: La linea y/o rasante municipal, deberan alcanzar a la distancia del eje de via hasta la propiedad.             
               </td>             
            </tr>  	         
         </table>	
            ...
            <tr>
               <td width='60%' >
                  <table border='0' width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr>
                        <td  colspan='2' style='font-family: Arial; font-size: 10pt; font-weight:bold; border-bottom: 1px solid black;'>6. ELEMENTOS SALIENTES EN VIA Y RETIROS DE CONSTRUCCION</td>
                     </tr>

                     <tr style='font-family: Arial; font-size: 9pt; font-weight:bold;'>
                        <td colspan='1' align='center' width='50%'><img src='http://$server/$folder/graphics/uso/6_linea nivel.jpg' alt='imagen' width='100%' border='0'></td>
                        <td colspan='1' align='center' width='50%'><img src='http://$server/$folder/graphics/uso/7_linea nivel.jpg' alt='imagen' width='100%' border='0'></td>
                     </tr>
                      <tr style='font-family: Arial; font-size: 9pt; font-weight:bold;'>
                        <td colspan='1' align='center' width='50%'><img src='http://$server/$folder/graphics/uso/8_linea nivel.jpg' alt='imagen' width='100%' border='0'></td>
                        <td colspan='1' align='center' width='50%'><img src='http://$server/$folder/graphics/uso/9_linea nivel.jpg' alt='imagen' width='100%' border='0'></td>
                     </tr>
                  </table>              
               </td>
               ...
               <td width='40%'>
                  <table width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr>
                        <td colspan='2' width='100%' style='font-family: Arial; font-size: 10pt; font-weight:bold; border-bottom: 1px solid black;'>7. NORMAS DE EDIFICACION</td>
                     </tr>                       
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Tipo de edificacion.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'> $tip_edi</td>
                     </tr>     
                      <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Retiro frontal.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'>$ret_fro</td>
                     </tr>  
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Retiro lateral.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'>$ret_lat</td>
                     </tr> 
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Retiro posterior.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'$ret_pos</td>
                     </tr>  
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Voladizos.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'>$voladizos</td>
                     </tr>    
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Altura de linderos.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'> $alt_de_lin</td>
                     </tr> 
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Altura de verja.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'>$alt_de_ver</td>
                     </tr> 
                     <tr style='font-family: Arial; font-size: 9pt;'>
                        <td colspan='1' width='70%' style='border-bottom: 1px solid black;'>&nbsp Otros de acuerdo a sus usos.</td>
                        <td colspan='1' width='30%' style='border-bottom: 1px solid black;'>$otro_usos</td>
                     </tr>    
                     <tr style='font-family: Arial; font-size: 2pt;'>
                        <td colspan='2' width='30%'>&nbsp</td>
                     </tr>                                                                                                                                                                                          
                  </table>

                  <table width='100%' style='font-family: Arial; font-size: 8pt; border: 1px solid black;'>
                     <tr>
                        <td colspan='2' width='100%' style='font-family: Arial; font-size: 10pt; font-weight:bold; '>8. CODIGO CIVIL:</td>
                     </tr> 
                    <tr>
                        <td colspan='2' width='100%' style='font-family: Arial; font-size: 9pt; font-weight:bold; '>&nbsp &nbsp &nbsp LIMITACIONES Y DERECHO PROPIETARIO</td>
                     </tr>                      
                     <tr>
                        <td colspan='1' width='20%' style='font-family: Arial; font-size: 7pt;'>
                           <p>$vis_dir</p>
                           <p>$vis_obl</p>
                           <p>$cai_agu</p>
                        </td>
