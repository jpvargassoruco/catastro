...
#echo "<br>COD:$cod_uv ,$cod_man,$cod_pred,$the_geom_nuevo";									
				...
				if ($check_info_predio == 0) {
	                ...
	                $dom_dpto = $info['dom_dpto']; $dom_ciu	= utf8_decode ($info['dom_ciu']); $dom_dir = utf8_decode ($info['dom_dir']);
                     $adq_modo = $info['adq_modo']; $adq_doc = $info['adq_doc'];
					$adq_fech = $fecha;
					$der_num = $info['der_num']; 
					if ($info['der_fech'] == "") {
						$der_fech = "1900-01-01";
						} else $der_fech = $info['der_fech'];									 
					...
					$ser_alu = $info['ser_alu']; $ser_cab = $info['ser_cab'];  
					...
					$esp_aac = $info['esp_aac']; $esp_tas = $info['esp_tas']; $esp_tae = $info['esp_tae']; 
					$esp_ser = $info['esp_ser']; $esp_gar = $info['esp_gar']; $esp_dep = $info['esp_dep'];
					$mej_lav = $info['mej_lav']; $mej_par = $info['mej_par']; $mej_hor = $info['mej_hor']; 
					$mej_pis = $info['mej_pis']; $mej_otr = $info['mej_otr'];
...
#									   $sql="SELECT edi_num, st_intersects (the_geom,(SELECT the_geom from predios where cod_cat ='$cod_cat')) AS inter 
	    ...
	    $cod_cat = $_POST["cod_fusion"];
			...
			} else $cod_cat_ant = $_POST["col_cod"];  
			########################################
...
if ((isset($_POST["recuperar"])) AND ($_POST["recuperar"] == "OK")) {
   # $no_de_intermed = $_POST["no_de_intermed"]; 
	 # if ($no_de_intermed > 0) {
	 #    $error = true;
	 #		$mensaje_de_error = "Error: Primero tiene que recuperar los Predios Intermedios!";
	 # } else {
	 $cod_cat = $_POST["cod_cat"];
...
#echo "COL_VALUE: $col_value,$cod_cat_heredero[$k]<br>";							
               ...
               $tit = pg_fetch_array($result2, null, PGSQL_ASSOC);
			         $tit_1pat = utf8_decode($tit['tit_1pat']); $tit_1mat = utf8_decode($tit['tit_1mat']);
				       $tit_1nom1 = utf8_decode($tit['tit_1nom1']); $tit_1nom2 = utf8_decode($tit['tit_1nom2']);
...
echo "<div class=\"row\">\n";	
	echo "<div  class=\"col-12 col-md-12\">\n";
			echo "<h5 class=\"text-primary text-center pt-2\">Datos del Predio</h5>\n"; 			 	 
	echo "</div>\n";  
echo "</div>\n"; 
...
echo "<div class=\"row\">\n";	
	...
	echo "<div  class=\"col-6 col-md-1 bodyTextH\">CODIGO:</div>\n";
	echo "<div  class=\"col-6 col-md-2 \">$cod_cat - $id_inmu</div>\n";			
	echo "<div  class=\"col-6 col-md-1 bodyTextH\">DIRECCION:</div>\n";
	echo "<div  class=\"col-6 col-md-5\"> $direccion</div>\n";
	echo "<div  class=\"col-6 col-md-1 bodyTextH\">REGIMEN:</div>\n";
	echo "<div  class=\"col-6 col-md-1\">$regimen</div>\n";		
echo "</div>\n"; 
	...
	if ($activo == 1) {
		...
		echo "<div id=\"tabs\">\n";
			echo "<ul class=\"nav nav-tabs\">\n";
				echo "<li class=\"nav-item\"><a class=\"nav-link active\" href=\"#tab-1\"><span>Datos</span></a></li>\n";
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-2\"><span>Edificaciones</span></a></li>\n";
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-3\"><span>Fotos</span></a></li>\n";
				#echo "<li  class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-4\"><span>Geometría</span></a></li>\n";	
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-5\"><span>Planos</span></a></li>\n";
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-6\"><span>Modificar</span></a></li>\n";	
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-7\"><span>Borrar</span></a></li>\n";	 
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-8\"><span>Cambios</span></a></li>\n";
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-9\"><span>Transfer</span></a></li>\n";		  
				echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#tab-10\"><span>Impuestos</span></a></li>\n";	 	  
			echo "</ul>\n";
				echo "<div id=\"tab-1\">\n";
				...
				echo "<tr>\n";                       
				echo "<td valign=\"top\" height=\"180\" colspan=\"3\" class=\"bodyText\">\n"; 
				echo "<fieldset class=\"border p-2\"><legend  class=\"float-none w-auto px-3\">Historial del Predio</legend>\n";
