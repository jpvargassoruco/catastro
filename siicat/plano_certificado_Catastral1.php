...
echo "<table border=\"0\" align=\"center\" cellpadding=\"0\" width=\"770px\">\n";   # 3 Columnas
   echo "<tr height=\"40px\">\n";
      echo "<td width=\"15%\">\n";
         ...
         echo "<img border='0' src='http://$server/graphics/boton_atras.png'></a>\n";	
      echo "</td>\n";  
      echo "<td width=\"70%\" align=\"center\" class=\"bodyText\">\n";
      echo "</td>\n"; 
      echo "<td width=\"15%\" align=\"center\">\n"; 
      echo "&nbsp&nbsp <a href=\"index.php?mod=5&inmu=$id_inmu&id=$session_id#tab-5\" alt='' title='Volver a la pantalla anterior'>\n";		
      echo "<img border='0' src='http://$server/graphics/Save 1.png'></a>\n";	      
      echo "</td>\n"; 
   echo "</tr>\n";	
   echo "<tr>\n";
      echo "<td valign=\"top\" colspan=\"3\">\n";
      include "plano_catastral_certificado_generar1.php";
      echo "<iframe frameborder=\"0\" name=\"mapserver\" src=\"http://$server/tmp/pc$cod_cat.html\" id=\"content\" width=\"750px\" height=\"1250px\" align=\"left\" scrolling=\"no\"  noresize=\"no\" marginwidth=\"0\" marginheight=\"0\">\n";
      echo "</iframe>\n";	
      echo "</td>\n";	 
   echo "</tr>\n";		
echo "</table>\n";
