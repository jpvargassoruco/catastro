...
} else die ("No tiene el permiso de acceder a la p�gina solicitada!"); 
...
while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {      
   ...
   echo "                        <option id=\"form0\" value=\"Dia\" $selected_fecha[2]>1 Día</option>\n";	 
   echo "                        <option id=\"form0\" value=\"Semana\" $selected_fecha[3]>1 Semana</option>\n";
   echo "                        <option id=\"form0\" value=\"2 Semanas\" $selected_fecha[4]>2 Semanas</option>\n";	 
   echo "                        <option id=\"form0\" value=\"Mes\" $selected_fecha[5]>1 Mes</option>\n";	 
   echo "                        <option id=\"form0\" value=\"6 Meses\" $selected_fecha[6]>6 Meses</option>\n";	 	 
   echo "                        <option id=\"form0\" value=\"Ano\" $selected_fecha[7]>1 Año</option>\n";	 	 
   echo "                     </select>\n";	  	 
	 echo "                  </td>\n";
	 echo "                  <td width=\"1%\"></td>\n";   #Col. 9     	  	 
